export const COUNTRIES = {
  ...
  ma: {
    ...
    regions: [
      ...
      'مكناس','وجدة','القنيطرة','تطوان','سلا','خريبكة',
      'بني ملال','الجديدة','تازة','الحسيمة','ورزازات','الناظور',
      'العرائش','الرشيدية','إفران','خنيفرة','آسفي','الصويرة',
      'تيزنيت','سيدي إفني','طاطا','زاكورة','فيكيك','جرادة'
    ]
  }
}
